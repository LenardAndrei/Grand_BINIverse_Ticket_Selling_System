...
public class SeatingGen {
    ...
    public SeatingGen(int numSeats) {
    ...
    // Method to select a seat for specific day
    ...
    // Method to get seat name for specific day
    ...
    private boolean loadSeatAvailability(int day) {
        String filePath = "seat_availability_Gen_day" + day + ".txt";
